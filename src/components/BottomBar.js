  ...
  render() {
    return (
      <View visible={this.state.barActive} style={BottomBarStyles.container}>
        <TouchableOpacity
          onPress={() => {
            this.activate('Gallery');
          }}
          style={
            Globals.buttonActive === 'Gallery'
              ? BottomBarStyles.galleryActive
              : BottomBarStyles.gallery
          }>
          <IconMCI
            style={
              Globals.buttonActive === 'Gallery'
                ? BottomBarStyles.iconActive
                : BottomBarStyles.icon
            }
            name="camera"
            size={20}
          />
        ...
        <TouchableOpacity
          ...
          style={
            Globals.buttonActive === 'Location'
              ? BottomBarStyles.locationActive
              : BottomBarStyles.location
          }>
          <IconMI
            style={
              Globals.buttonActive === 'Location'
